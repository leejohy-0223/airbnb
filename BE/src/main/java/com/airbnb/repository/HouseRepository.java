...
public interface HouseRepository extends JpaRepository<House, Long> {
    ...
    @Query("SELECT NEW com.airbnb.api.houses.dto.NumberOfHousesByPriceResponse(FUNCTION('FLOOR', (h.price / 10000)), count(h.id)) "
        + "FROM House h "
    ...
    List<NumberOfHousesByPriceResponse> numberOfHousesInTheRange(@Param("point") Point point, @Param("distance") int distance);
