...
VALUES (3, 4, 4.5, '아늑한 집', '원룸1', 'house1', ST_GeomFromText('POINT(127.029371 37.495421)'), 65000, 1),
       ...
       (3, 4, 4.5, '아늑한 집', '원룸4', 'house4', ST_GeomFromText('POINT(127.029371 37.495424)'), 85000, 2),
